...
class BrukerReaderTester:
    ...
    def test_data_path_validation(self) -> Dict[str, Any]:
        ...
        try:
            _invalid_reader = BrukerReader(Path("/nonexistent/path.d"))  # noqa: F841
    ...
    def test_performance(self) -> Dict[str, Any]:
        ...
        with BrukerReader(self.test_data_path) as reader:
            ...
            start_time = time.time()
            _dimensions = reader.get_dimensions()  # noqa: F841
    ...
    def test_error_handling(self) -> Dict[str, Any]:
        ...
        try:
            with BrukerReader(self.test_data_path) as reader:
                ...
                reader.coordinate_cache.get_coordinate(999999)
